...
- (IBAction)registerBtnClicked:(id)sender {
    ...
    // 如果是“全新注册用户”
        ...
        post = [[NSString alloc] initWithFormat:@"action=register&username=%@&password=%@&city=%ld&city2=%ld&addrdetail=%@&token=%@", encodedUserName, encodedPassword, (long)userRegion, (long)cityID.integerValue, encodeAddr ? encodeAddr : @"", [[NSUserDefaults standardUserDefaults] objectForKey:PUSH_TOKEN]];
    }
