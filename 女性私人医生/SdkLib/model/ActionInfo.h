...
typedef enum {
    ...
    ACTION_ID_LOGIN_CHAT = 301,
    ACTION_ID_LOGOUT_CHAT = 302,
    ACTION_ID_SEND_PNTOKEN = 303,
    ACTION_ID_SEND_MSG = 304,
    ACTION_ID_RECV_MSG = 305,
    ACTION_ID_RECEIPT_MSG = 306,
    ACTION_ID_GET_HIS_MSG = 307,
    ACTION_ID_GET_MEMBER_LIST = 308,
    ACTION_ID_CHAT_LIST = 309,
    ACTION_ID_CLOSE_CHAT = 310,
    ACTION_ID_NEW_MSG_NOTICE = 311,
